...
// TODO - re-enable this
    ...
    if (!rv) {
      ...
      reply = (redisReply *)redisCommand(c,"HMGET LASTUPDT VALUE"); strcpy(gbtstatus->LASTUPDT,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET LST VALUE"); strcpy(gbtstatus->LST,reply->element[0]->str); freeReplyObject(reply);
      reply = (redisReply *)redisCommand(c,"HMGET LST STIME"); gbtstatus->LSTSTIME = atol(reply->element[0]->str); freeReplyObject(reply);
      reply = (redisReply *)redisCommand(c,"HMGET UTC VALUE"); strcpy(gbtstatus->UTC,reply->element[0]->str); freeReplyObject(reply);
      reply = (redisReply *)redisCommand(c,"HMGET UTC STIME"); gbtstatus->UTCSTIME = atol(reply->element[0]->str); freeReplyObject(reply);
      reply = (redisReply *)redisCommand(c,"HMGET EPOCH VALUE"); strcpy(gbtstatus->EPOCH,reply->element[0]->str); freeReplyObject(reply);
      reply = (redisReply *)redisCommand(c,"HMGET EPOCH STIME"); gbtstatus->EPOCHSTIME = atol(reply->element[0]->str); freeReplyObject(reply);
      reply = (redisReply *)redisCommand(c,"HMGET MAJTYPE VALUE"); strcpy(gbtstatus->MAJTYPE,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET MINTYPE VALUE"); strcpy(gbtstatus->MINTYPE,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET MAJOR VALUE"); strcpy(gbtstatus->MAJOR,reply->element[0]->str); freeReplyObject(reply);
      reply = (redisReply *)redisCommand(c,"HMGET MAJOR STIME"); gbtstatus->MAJORSTIME = atol(reply->element[0]->str); freeReplyObject(reply);
      reply = (redisReply *)redisCommand(c,"HMGET MINOR VALUE"); strcpy(gbtstatus->MINOR,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET LPCS VALUE"); strcpy(gbtstatus->LPCS,reply->element[0]->str); freeReplyObject(reply);
      reply = (redisReply *)redisCommand(c,"HMGET LPCS STIME"); gbtstatus->LPCSSTIME = atol(reply->element[0]->str); freeReplyObject(reply);
      reply = (redisReply *)redisCommand(c,"HMGET FOCUSOFF VALUE"); strcpy(gbtstatus->FOCUSOFF,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ANTMOT VALUE"); strcpy(gbtstatus->ANTMOT,reply->element[0]->str); freeReplyObject(reply);
      reply = (redisReply *)redisCommand(c,"HMGET ANTMOT STIME"); gbtstatus->ANTMOTSTIME = atol(reply->element[0]->str); freeReplyObject(reply);
      reply = (redisReply *)redisCommand(c,"HMGET RECEIVER VALUE"); strcpy(gbtstatus->RECEIVER,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VELFRAME VALUE"); strcpy(gbtstatus->VELFRAME,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VELDEF VALUE"); strcpy(gbtstatus->VELDEF,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATBOT1EO VALUE"); strcpy(gbtstatus->ATBOT1EO,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATBOT1XO VALUE"); strcpy(gbtstatus->ATBOT1XO,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATBOT1NM VALUE"); strcpy(gbtstatus->ATBOT1NM,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATBOT1F1 VALUE"); strcpy(gbtstatus->ATBOT1F1,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATBOT1F2 VALUE"); strcpy(gbtstatus->ATBOT1F2,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATFCTRMD VALUE"); strcpy(gbtstatus->ATFCTRMD,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATLFCX VALUE"); strcpy(gbtstatus->ATLFCX,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATLFCXT VALUE"); strcpy(gbtstatus->ATLFCXT,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATLFCY VALUE"); strcpy(gbtstatus->ATLFCY,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATLFCYT VALUE"); strcpy(gbtstatus->ATLFCYT,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATLFCZ VALUE"); strcpy(gbtstatus->ATLFCZ,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATLFCZT VALUE"); strcpy(gbtstatus->ATLFCZT,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATLPOAZ1 VALUE"); strcpy(gbtstatus->ATLPOAZ1,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATLPOAZ2 VALUE"); strcpy(gbtstatus->ATLPOAZ2,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATLPOEL VALUE"); strcpy(gbtstatus->ATLPOEL,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATMCRAJ2 VALUE"); strcpy(gbtstatus->ATMCRAJ2,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATMCDCJ2 VALUE"); strcpy(gbtstatus->ATMCDCJ2,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATOPTMOD VALUE"); strcpy(gbtstatus->ATOPTMOD,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATRECVR VALUE"); strcpy(gbtstatus->ATRECVR,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET ATRXOCTA VALUE"); strcpy(gbtstatus->ATRXOCTA,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET BAMMPWR1 VALUE"); strcpy(gbtstatus->BAMMPWR1,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET BAMMPWR2 VALUE"); strcpy(gbtstatus->BAMMPWR2,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET LO1APSFQ VALUE"); strcpy(gbtstatus->LO1APSFQ,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET LO1BPSFQ VALUE"); strcpy(gbtstatus->LO1BPSFQ,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCPROJID VALUE"); strcpy(gbtstatus->SCPROJID,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSNUMBR VALUE"); strcpy(gbtstatus->SCSNUMBR,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSOURCE VALUE"); strcpy(gbtstatus->SCSOURCE,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSTATE VALUE"); strcpy(gbtstatus->SCSTATE,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSACTSF VALUE"); strcpy(gbtstatus->SCSACTSF,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSANAFR VALUE"); strcpy(gbtstatus->SCSANAFR,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSANTEN VALUE"); strcpy(gbtstatus->SCSANTEN,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSARCHI VALUE"); strcpy(gbtstatus->SCSARCHI,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSBCPM VALUE"); strcpy(gbtstatus->SCSBCPM,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSCCB26 VALUE"); strcpy(gbtstatus->SCSCCB26,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSCRACK VALUE"); strcpy(gbtstatus->SCSCRACK,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSDCR VALUE"); strcpy(gbtstatus->SCSDCR,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSGUPPI VALUE"); strcpy(gbtstatus->SCSGUPPI,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSHOLOG VALUE"); strcpy(gbtstatus->SCSHOLOG,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSIFM VALUE"); strcpy(gbtstatus->SCSIFM,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSIFR VALUE"); strcpy(gbtstatus->SCSIFR,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSLO1 VALUE"); strcpy(gbtstatus->SCSLO1,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSMEASUR VALUE"); strcpy(gbtstatus->SCSMEASUR,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSQUADRD VALUE"); strcpy(gbtstatus->SCSQUADRD,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSR1 VALUE"); strcpy(gbtstatus->SCSR1,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSR12 VALUE"); strcpy(gbtstatus->SCSR12,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSR18 VALUE"); strcpy(gbtstatus->SCSR18,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSR2 VALUE"); strcpy(gbtstatus->SCSR2,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSR26 VALUE"); strcpy(gbtstatus->SCSR26,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSR40 VALUE"); strcpy(gbtstatus->SCSR40,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSR4 VALUE"); strcpy(gbtstatus->SCSR4,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSR68 VALUE"); strcpy(gbtstatus->SCSR68,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSR8 VALUE"); strcpy(gbtstatus->SCSR8,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSRA1 VALUE"); strcpy(gbtstatus->SCSRA1,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSRA18 VALUE"); strcpy(gbtstatus->SCSRA18,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSRMBA1 VALUE"); strcpy(gbtstatus->SCSRMBA1,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSRPAR VALUE"); strcpy(gbtstatus->SCSRPAR,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSRPF1 VALUE"); strcpy(gbtstatus->SCSRPF1,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSRPF2 VALUE"); strcpy(gbtstatus->SCSRPF2,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSSPROC VALUE"); strcpy(gbtstatus->SCSSPROC,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSSPECT VALUE"); strcpy(gbtstatus->SCSSPECT,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSSWSS VALUE"); strcpy(gbtstatus->SCSSWSS,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSVEGAS VALUE"); strcpy(gbtstatus->SCSVEGAS,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET SCSZPECT VALUE"); strcpy(gbtstatus->SCSZPECT,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VEGSFBW1 VALUE"); strcpy(gbtstatus->VEGSFBW1,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VEGSFBW2 VALUE"); strcpy(gbtstatus->VEGSFBW2,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VEGSFBW3 VALUE"); strcpy(gbtstatus->VEGSFBW3,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VEGSFBW4 VALUE"); strcpy(gbtstatus->VEGSFBW4,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VEGSFBW5 VALUE"); strcpy(gbtstatus->VEGSFBW5,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VEGSFBW6 VALUE"); strcpy(gbtstatus->VEGSFBW6,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VEGSFBW7 VALUE"); strcpy(gbtstatus->VEGSFBW7,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VEGSFBW8 VALUE"); strcpy(gbtstatus->VEGSFBW8,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VEGSSBAM VALUE"); strcpy(gbtstatus->VEGSSBAM,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VEGSSBBM VALUE"); strcpy(gbtstatus->VEGSSBBM,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VEGSSBCM VALUE"); strcpy(gbtstatus->VEGSSBCM,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VEGSSBDM VALUE"); strcpy(gbtstatus->VEGSSBDM,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VEGSSBEM VALUE"); strcpy(gbtstatus->VEGSSBEM,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VEGSSBFM VALUE"); strcpy(gbtstatus->VEGSSBFM,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VEGSSBGM VALUE"); strcpy(gbtstatus->VEGSSBGM,reply->element[0]->str); freeReplyObject(reply);
      ...
      reply = (redisReply *)redisCommand(c,"HMGET VEGSSBHM VALUE"); strcpy(gbtstatus->VEGSSBHM,reply->element[0]->str); freeReplyObject(reply);
